...
import 'package:firstffasubmission/data/api/connection_service.dart';
import 'package:firstffasubmission/model/detail_restaurant.dart';
...
class RestaurantDetailProvider extends ChangeNotifier {
  RestaurantDetailProvider(this.context, {this.id}) {
  ...
  DetailRestaurant get result => _detailRestaurantResult;
  ...
  Future<DetailRestaurant> getRestaurantDetail() async {
